...
CREATE TABLE `address` (
  ...
  `mbr_id` int NOT NULL COMMENT '所属会员',
...
INSERT INTO `address` VALUES (8,'cyh','111','abcd','1414',15,1);
...
INSERT INTO `administrator` VALUES (1,'11111','11111','ccc','aa@qq.com','2020-11-27');
...
CREATE TABLE `category` (
  ...
  `p_id` int DEFAULT NULL COMMENT '父类目编号',
  `order_weight` int DEFAULT NULL COMMENT '排序权重',
  PRIMARY KEY (`id`),
...
INSERT INTO `category` VALUES (1,'手      机','shouji',NULL,10),(2,'电脑办公','diannaobangong',NULL,10),(3,'影音娱乐','yingyinyule',NULL,10),(4,'小  家 电','xiaojiadian',NULL,10),(5,'大  家 电','dajiadian',NULL,10),(6,'摄影器材','sheyingqicai',NULL,10),(7,'酷玩潮品','yidong',NULL,10),(8,'移动手机','zhinengji',1,10),(9,'联通手机','liantong',1,10),(10,'电信手机','dianxin',1,10),(11,'笔记本','bijiben',2,10),(12,'台式机','taishiji',2,10),(13,'数码影音','shumayingyin',3,10),(14,'家庭影院','jiatingyingyuan',3,10),(15,'个护电器','gehudianqi',4,10),(16,'健康电器','jiankangdianqi',4,10),(17,'冰箱','bingxiang',5,10),(18,'空调','kongtiao',5,10),(19,'洗衣机','xiyiji',5,10),(20,'摄影摄像','sheyingshexiang',6,10),(21,'摄影配件','sheyingpeijian',6,10),(22,'潮品','chaopin',7,10);
...
CREATE TABLE `item` (
  ...
  `amount` int DEFAULT NULL COMMENT '单品数量',
...
INSERT INTO `item` VALUES (1,1,3,2,1598.00,1398.00),(2,1,14,1,999.00,999.00),(3,2,12,2,6798.00,6198.00),(4,2,15,2,1998.00,1998.00),(5,3,6,4,800.00,672.00),(6,4,16,3,8100.00,6000.00),(7,5,22,1,6999.00,6530.00),(8,6,17,1,1998.00,1500.00),(9,7,24,1,1999.00,1500.00),(10,9,11,1,3699.00,3199.00),(11,10,26,1,8999.00,8700.00),(12,11,6,1,200.00,168.00),(13,11,25,1,6999.00,6850.00),(14,12,18,1,150.00,130.00),(15,13,11,1,3699.00,3199.00),(16,14,2,1,5288.00,4880.00),(17,15,21,1,799.00,599.00);
...
INSERT INTO `member` VALUES (1,'119','2016','HYC','黄运驰','119@sina.com',1,'2016-07-01 08:50:22'),(2,'122','122','通哥','交通警察','122@126.com',0,'2016-07-01 15:12:08'),(3,'114','114','查查查','老查','411@126.com',1,'2016-07-01 16:53:24'),(15,'111','111','匿名',NULL,NULL,0,'2020-11-20 09:31:19'),(16,'2121','1111','匿名',NULL,NULL,0,'2020-11-20 09:32:47'),(17,'','','匿名',NULL,NULL,0,'2020-11-27 02:24:41'),(18,'19927522639','111','匿名',NULL,NULL,0,'2020-11-27 02:25:44'),(19,'11111','11111','匿名',NULL,NULL,0,'2020-11-27 02:41:18'),(20,'ccc','111','匿名',NULL,NULL,0,'2020-11-27 03:35:35');
...
CREATE TABLE `orders` (
  ...
  `buyer_id` int NOT NULL COMMENT '所属买家会员编号',
  `total_amount` int DEFAULT NULL COMMENT '商品总数量',
  ...
  `status` int NOT NULL COMMENT '订单状态：0下单,1待付款,2已付款,3待发货,4已发货,5己收货,6已完成,-1已取消',
  PRIMARY KEY (`id`),
...
INSERT INTO `orders` VALUES (9,'20201120182111464',15,1,3699.00,3199.00,'nothing','cyh','111','abcd','1414','2020-11-20 10:21:07',NULL,NULL,NULL,2),(10,'20201124110302971',15,1,8999.00,8700.00,'','cyh','111','abcd','1414','2020-11-24 03:02:49',NULL,NULL,NULL,2),(11,'20201127133733469',15,2,7199.00,7018.00,'','cyh','111','abcd','1414','2020-11-27 05:37:15',NULL,NULL,NULL,2),(12,'20201127160445491',1,1,150.00,130.00,'','王5','022-87188666','天津市南开区华苑路26号dddddd','300384','2020-11-27 08:04:44',NULL,NULL,NULL,2),(13,'20201127160453916',1,1,3699.00,3199.00,'','王5','022-87188666','天津市南开区华苑路26号dddddd','300384','2020-11-27 08:04:53',NULL,NULL,NULL,2),(14,'20201127160501276',1,1,5288.00,4880.00,'','王5','022-87188666','天津市南开区华苑路26号dddddd','300384','2020-11-27 08:05:00',NULL,NULL,NULL,2),(15,'20201127160508198',1,1,799.00,599.00,'','王5','022-87188666','天津市南开区华苑路26号dddddd','300384','2020-11-27 08:05:07',NULL,NULL,NULL,5);
...
CREATE TABLE `product` (
  ...
  `cate_id` int NOT NULL COMMENT '所属类目编号',
  `thumbnail` varchar(128) DEFAULT NULL COMMENT '主配图片',
  `inventory` int DEFAULT '0' COMMENT '库存数量',
  `sales_volume` int DEFAULT '0' COMMENT '售出数量',
...
INSERT INTO `product` VALUES (1,'Nokia 经典通话机（第七代）',9,'nokia.jpg',200,0,280.00,120.00,'<div style=\"text-align:center;\">\r\n<img src=\"./img/n1.jpg\" alt=\"\" />\r\n<img src=\"./img/n2.jpg\" alt=\"\" /> \r\n<img src=\"./img/n3.jpg\" alt=\"\" /> \r\n<img src=\"./img/n4.jpg\" alt=\"\" /> \r\n</div>','手机中的战斗机。待机时间15天。','2016-06-01 17:37:59','2016-06-03 18:50:00'),(2,'iphone 6s plus (64G)',8,'iphone6s.jpg',123,0,5288.00,4880.00,'<div style=\"text-align:center;\">\r\n<img src=\"./img/detail-1.jpg\" alt=\"\" />\n<img src=\"./img/detail-2.jpg\" alt=\"\" />\n<img src=\"./img/detail-3.jpg\" alt=\"\" />\n<img src=\"./img/detail-4.jpg\" alt=\"\" />\r\n</div>','','2016-06-01 22:38:11','2016-06-02 18:28:00'),(3,'魅蓝3 礼盒版',9,'meinote3.jpg',100,0,799.00,699.00,'<div style=\"text-align:center;\">\r\n	<img src=\"./img/me1.jpg\" alt=\"\" />\n<img src=\"./img/me2.jpg\" alt=\"\" />\n<img src=\"./img/me3.jpg\" alt=\"\" />\n<img src=\"./img/me4.jpg\" alt=\"\" />\r\n</div>','<h1 style=\"font-size:16px;font-family:arial, \'microsoft yahei\';color:#666666;background-color:#FFFFFF;\">\r\n	全网通 4G手机 银白色 标配版(2G RAM+16G ROM)标配\r\n</h1>','2016-06-03 09:44:28','2016-06-05 09:40:00'),(4,'小米Max',9,'xiaomi.jpg',1000,0,1699.00,1699.00,'<div style=\"text-align:center;\">\r\n	<img src=\"./img/mi-1.jpg\" alt=\"\" />\n<img src=\"./img/mi-2.jpg\" alt=\"\" />\n<img src=\"./img/mi-3.jpg\" alt=\"\" />\n<img src=\"./img/mi-4.jpg\" alt=\"\" />\n<img src=\"./img/mi-5.jpg\" alt=\"\" />\n<img src=\"./img/mi-6.jpg\" alt=\"\" /> \r\n</div>','<h1 style=\"font-size:16px;font-family:arial, \'microsoft yahei\';color:#666666;background-color:#FFFFFF;\">\r\n	4G手机 双卡双待 金色 全网通(3G RAM+32G ROM)标配\r\n</h1>','2016-06-03 09:50:25','2016-06-10 09:00:00'),(5,'华为 P9 全网通 3GB+32GB版 流光金 移动联通电信4G手机 双卡双待',10,'huawei.jpg',2000,0,3188.00,3188.00,'<div style=\"text-align:center;\">\r\n	<img src=\"./img/hw-1.jpg\" alt=\"\" /> \r\n</div>','<h1 style=\"font-size:16px;font-family:arial, \'microsoft yahei\';color:#666666;background-color:#FFFFFF;\">\r\n	全网通 3GB+32GB版 流光金 移动联通电信4G手机 双卡双待\r\n</h1>','2016-06-03 09:54:00','2016-06-10 09:50:00'),(6,'优思 US1 移动 联通 三防 老人手机 迷彩',8,'uniscope.jpg',500,0,200.00,168.00,'<div style=\"text-align:center;\">\r\n<img src=\"./img/us-1.jpg\" alt=\"\" /> \n<img src=\"./img/us-2.jpg\" alt=\"\" />\n <img src=\"./img/us-3.jpg\" alt=\"\" /> \n<img src=\"./img/us-4.jpg\" alt=\"\" /> \n<img src=\"./img/us-5.jpg\" alt=\"\" /> \r\n</div>','<span style=\"color:#E3393C;font-family:arial, \'microsoft yahei\';font-size:14px;line-height:20px;background-color:#FFFFFF;\">耐磨防摔 户外三防 耐磨防摔 一键手电 充电宝功能</span>','2016-06-03 09:58:58','2016-06-03 09:57:00'),(7,'Apple MacBook Pro 13.3英寸笔记本电脑',11,'mbp.jpg',300,0,9288.00,9200.00,'<div style=\"text-align:center;\">\r\n	<img src=\"./img/mbp-1.jpg\" alt=\"\" />\n<img src=\"./img/mbp-2.jpg\" alt=\"\" />\r\n</div>','<h1 style=\"font-size:16px;font-family:arial, \'microsoft yahei\';color:#666666;background-color:#FFFFFF;\">\r\n	银色(Core i5 处理器/8GB内存/128GB SSD闪存/Retina屏 MF839CH/A)\r\n</h1>','2016-06-03 10:05:00','2016-06-03 10:03:00'),(8,'ThinkPad X1 Carbon (20FBA00XCD) 14英寸超极笔记本电脑',11,'thinkpad-x1.jpg',300,0,9999.00,8999.00,'<div style=\"text-align:center;\">\r\n	<img src=\"./img/thinkpad-x1-1.jpg\" alt=\"\" />\r\n</div>','<h1 style=\"font-size:16px;font-family:arial, \'microsoft yahei\';color:#666666;background-color:#FFFFFF;\">\r\n	i5-6200U 8G 192GB SSD FHD IPS Win10 64位\r\n</h1>','2016-06-03 10:10:45','2016-06-03 10:09:00'),(9,'外星人（Alienware）ALW13E-4728S 13.3英寸笔记本电脑',11,'alienware.jpg',400,0,12999.00,12999.00,'<div style=\"text-align:center;\">\r\n	<img src=\"./img/alienware-1.jpg\" alt=\"\" /> <img src=\"./img/alienware-2.jpg\" alt=\"\" /> <img src=\"./img/alienware-3.jpg\" alt=\"\" /> \r\n</div>','<h1 style=\"font-size:16px;font-family:arial, \'microsoft yahei\';color:#666666;background-color:#FFFFFF;\">\r\n	（I7-6500U 8G 256GB SSD GTX 960M 4G独显 Win10）银\r\n</h1>','2016-06-03 10:31:11','2016-06-03 10:28:00'),(10,'戴尔（DELL）XPS 13-9350-R1708 13.3英寸微边框笔记本电脑',11,'dell.jpg',125,0,8999.00,8999.00,'<div style=\"text-align:center;\">\r\n<img src=\"./img/dell-1.jpg\" alt=\"\" />\n<img src=\"./img/dell-2.jpg\" alt=\"\" />\n<img src=\"./img/dell-3.jpg\" alt=\"\" />\r\n</div>','<h1 style=\"font-size:16px;font-family:arial, \'microsoft yahei\';color:#666666;background-color:#FFFFFF;\">\r\n	（ i7-6500U 8G 256GSSD Win10）银\r\n</h1>','2016-06-03 10:34:08','2016-06-03 10:33:00'),(11,'戴尔（DELL）Vostro 3800-R6308 台式电脑',12,'dell-desktop.jpg',1000,0,3699.00,3199.00,'<div style=\"text-align:center;\">\r\n	<img src=\"./img/dell-desktop-1.jpg\" alt=\"\" />\n<img src=\"./img/dell-desktop-2.jpg\" alt=\"\" />\r\n</div>','<h1 style=\"font-size:16px;font-family:arial, \'microsoft yahei\';color:#666666;background-color:#FFFFFF;\">\r\n	（i3-4170 4G 500G DVD 三年上门 三年硬盘保留Win7）黑\r\n</h1>','2016-06-03 10:39:46','2016-06-03 10:38:00'),(12,'联想（Lenovo）H3050台式电脑',12,'lenovo.jpg',1000,0,3399.00,3099.00,'<div style=\"text-align:center;\">\r\n	<img src=\"./img/lenovo-1.jpg\" alt=\"\" />\n<img src=\"./img/lenovo-2.jpg\" alt=\"\" />\r\n</div>','<h1 style=\"font-size:16px;font-family:arial, \'microsoft yahei\';color:#666666;background-color:#FFFFFF;\">\r\n	（i3-4170 4G 500G 集显 DVD 千兆网卡 Win10）20英寸\r\n</h1>','2016-06-03 10:43:17','2016-06-03 10:42:00'),(13,'Apple iPad mini 4 平板电脑 7.9英寸',11,'ipad.png',600,0,3288.00,3288.00,'<div style=\"text-align:center;\">\r\n<img src=\"./img/ipad-1.jpg\" alt=\"\" />\n<img src=\"./img/ipad-2.jpg\" alt=\"\" />\n<img src=\"./img/ipad-3.jpg\" alt=\"\" />\r\n</div>','<h1 style=\"font-size:16px;font-family:arial, \'microsoft yahei\';color:#666666;background-color:#FFFFFF;\">\r\n	（64G WLAN版/A8芯片/Retina显示屏/Touch ID技术 MK9J2CH）金色\r\n</h1>','2016-06-03 10:46:54','2016-06-03 10:45:00'),(14,'小米（XIAOMI）平板电脑2 WIFI版 7.9英寸',11,'mipad.jpg',400,0,999.00,999.00,'<div style=\"text-align:center;\">\r\n	<img src=\"./img/mipad-1.jpg\" alt=\"\" />\n<img src=\"./img/mipad-2.jpg\" alt=\"\" />\n<img src=\"./img/mipad-3.jpg\" alt=\"\" />\n<img src=\"./img/mipad-4.jpg\" alt=\"\" />\n<img src=\"./img/mipad-5.jpg\" alt=\"\" /><br />\r\n</div>','<h1 style=\"font-size:16px;font-family:arial, \'microsoft yahei\';color:#666666;background-color:#FFFFFF;\">\r\n	（Intel Z8500 2G/16G 500W/800W）香槟金\r\n</h1>','2016-06-03 10:52:14','2016-06-03 10:50:00'),(15,'乐视（Letv）乐1S 太子妃版 32GB 银色 移动联通4G手机 双卡双待',9,'letv.jpg',666,0,999.00,999.00,'<div style=\"text-align:center;\">\r\n<img src=\"./img/letv-1.jpg\" alt=\"\" />\r\n<img src=\"./img/letv-2.jpg\" alt=\"\" />\r\n<img src=\"./img/letv-3.jpg\" alt=\"\" />\r\n</div>','<span style=\"color:#E3393C;font-family:arial, \'microsoft yahei\';font-size:14px;line-height:20px;background-color:#FFFFFF;\">镜面指纹识别+快速充电+八核处理器+3GB+32GB内存！</span>','2016-06-03 11:04:39','2016-06-03 11:03:00'),(16,'创维（Skyworth）55X5 55英寸 六核智能酷开网络平板液晶电视(黑色)',14,'dajiadian01.jpg',100,100,2700.00,2000.00,'<div style=\"text-align:center;\">\r\n<img src=\"./img/dajiadian0101.jpg\" alt=\"\" />\r\n<img src=\"./img/dajiadian0102.jpg\" alt=\"\" />\r\n<img src=\"./img/dajiadian0103.jpg\" alt=\"\" />\r\n<img src=\"./img/dajiadian0104.jpg\" alt=\"\" />\r\n<img src=\"./img/dajiadian0105.jpg\" alt=\"\" />\r\n</div>',NULL,'2016-07-05 15:59:00','2016-07-05 15:59:05'),(17,'Beats Solo2 Wireless蓝牙耳机头戴式 无线耳麦手机耳机',13,'yingyinyule01.jpg',100,100,1998.00,1500.00,'<div style=\"text-align:center;\">\r\n<img src=\"./img/yingyinyule0101.jpg\" alt=\"\" />\r\n<img src=\"./img/yingyinyule0102.jpg\" alt=\"\" />\r\n<img src=\"./img/yingyinyule0103.jpg\" alt=\"\" />\r\n</div>',NULL,'2016-07-06 11:21:38','2016-07-06 11:21:41'),(18,'Edifier/漫步者 R101V笔记本电脑音响 多媒体台式小音箱2.1低音炮',13,'yingyinyule02.jpg',100,100,150.00,130.00,'<div style=\"text-align:center;\">\r\n<img src=\"./img/yingyinyule0201.jpg\" alt=\"\" />\r\n<img src=\"./img/yingyinyule0202.jpg\" alt=\"\" />\r\n<img src=\"./img/yingyinyule0203.jpg\" alt=\"\" />\r\n</div>',NULL,'2016-07-06 11:23:25','2016-07-06 11:23:28'),(19,'inphic/英菲克 I9 8核网络机顶盒无线高清硬盘播放器八核电视盒子',14,'yingyinyule03.jpg',100,50,399.00,350.00,'<div style=\"text-align:center;\">\r\n<img src=\"./img/yingyinyule0301.jpg\" alt=\"\" />\r\n<img src=\"./img/yingyinyule0302.jpg\" alt=\"\" />\r\n<img src=\"./img/yingyinyule0303.jpg\" alt=\"\" />\r\n</div>',NULL,'2016-07-06 13:47:05','2016-07-06 13:47:09'),(20,'飞利浦电动剃须刀S5080充电式全身水洗多功能三刀头S5000系列',15,'xiaojiadian01.jpg',500,50,699.00,599.00,'<div style=\"text-align:center;\">\r\n<img src=\"./img/xiaojiadian0101.jpg\" alt=\"\" />\r\n<img src=\"./img/xiaojiadian0102.jpg\" alt=\"\" />\r\n<img src=\"./img/xiaojiadian0103.jpg\" alt=\"\" />\r\n</div>',NULL,'2016-07-06 13:56:17','2016-07-06 13:56:20'),(21,'格力加湿器 家用静音 卧室迷你小型 办公室空气净化大雾量增湿器',16,'xiaojiadian02.jpg',500,50,799.00,599.00,'<div style=\"text-align:center;\">\r\n<img src=\"./img/xiaojiadian0201.jpg\" alt=\"\" />\r\n<img src=\"./img/xiaojiadian0202.jpg\" alt=\"\" />\r\n<img src=\"./img/xiaojiadian0203.jpg\" alt=\"\" />\r\n</div>',NULL,'2016-07-06 13:59:09','2016-07-06 13:59:11'),(22,'SIEMENS/西门子 BCD-610W(KA82NV06TI)双开门双门对开门电冰箱',17,'bingxiang01.jpg',500,50,6999.00,6530.00,'<div style=\"text-align:center;\">\r\n<img src=\"./img/bingxiang0101.jpg\" alt=\"\" />\r\n<img src=\"./img/bingxiang0102.jpg\" alt=\"\" />\r\n<img src=\"./img/bingxiang0103.jpg\" alt=\"\" />\r\n<img src=\"./img/bingxiang0104.jpg\" alt=\"\" />\r\n<img src=\"./img/bingxiang0105.jpg\" alt=\"\" />\r\n</div>',NULL,'2016-07-06 14:09:33','2016-07-06 14:09:36'),(23,'省电Kelon/科龙 KFR-35GW/ERQBN3(1L04) 大1.5匹智能冷暖空调挂机',18,'kongtiao01.jpg',500,100,2600.00,2300.00,'<div style=\"text-align:center;\">\r\n<img src=\"./img/kongtiao0101.jpg\" alt=\"\" />\r\n<img src=\"./img/kongtiao0102.jpg\" alt=\"\" />\r\n<img src=\"./img/kongtiao0103.jpg\" alt=\"\" />\r\n<img src=\"./img/kongtiao0104.jpg\" alt=\"\" />\r\n<img src=\"./img/kongtiao0105.jpg\" alt=\"\" />\r\n</div>',NULL,'2016-07-06 14:33:15','2016-07-06 14:33:18'),(24,'SIEMENS/西门子 XQG80-WM12P1681W 8KG变频滚筒 银色全自动洗衣机',19,'xiyiji01.jpg',500,500,1999.00,1500.00,'<div style=\"text-align:center;\">\r\n<img src=\"./img/xiyiji0101.jpg\" alt=\"\" />\r\n<img src=\"./img/xiyiji0102.jpg\" alt=\"\" /> \r\n<img src=\"./img/xiyiji0103.jpg\" alt=\"\" /> \r\n\r\n</div>',NULL,'2016-07-06 14:34:57','2016-07-06 14:35:00'),(25,'单反外观Sony/索尼 DSC-H400高清长焦射月数码照相机',20,'sheyingshexiang01.jpg',500,500,6999.00,6850.00,'<div style=\"text-align:center;\">\r\n<img src=\"./img/sheyingshexiang0101.jpg\" alt=\"\" />\r\n<img src=\"./img/sheyingshexiang0102.jpg\" alt=\"\" />\r\n<img src=\"./img/sheyingshexiang0103.jpg\" alt=\"\" />\r\n<img src=\"./img/sheyingshexiang0104.jpg\" alt=\"\" />\r\n</div>',NULL,'2016-07-06 14:42:39','2016-07-06 14:42:41'),(29,'areyousirius',1,'E:\\Eclipse IDE\\.metadata\\.plugins\\org.eclipse.wst.server.core\\tmp0\\wtpwebapps\\Market\\img/cnbc.jpg',111,0,111.00,11.00,'test',NULL,'2020-11-28 13:09:08',NULL);
...
-- Dump completed on 2020-11-30 18:55:16
