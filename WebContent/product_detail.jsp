					...
					<div class="row">
						<div class="col-xs-4">
							<div class="product-image">
								<img src="${pic_base}${product.thumbnail}" title="${product.name}" alt="${product.name}" style="max-height: 290px">
							</div>
						</div>
						<div class="col-xs-8">
								...
								<ul class="list-unstyled">
									<li>
										...
										<span class="attr-value">￥
											<del>
												<strong><fmt:formatNumber value="${product.price}" pattern="#,##0.00" /></strong>
											</del>
										</span>
									</li>
									<li>
										...
										<span class="attr-value">￥
											<strong class="text-danger" style="font-size: 16px"><fmt:formatNumber value="${product.sale_price}" pattern="#,##0.00" /></strong>
										</span>
									</li>
									<li>
										<span class="attr-name">状态</span> 
										<span class="attr-value">${product.inventory > product.sales_volume ? "有货" : "无货"}</span>
									</li>
									<li id="countBox">
