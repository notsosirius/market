...
public class Product implements Serializable {
	...
	public Product(String _name,Integer _cate_id,String _thumbnail,int _inventory,
			int _sales_volume,BigDecimal _price,BigDecimal _sale_price,String _detail_description,
			String _selling_description,Date _create_time,Date _sale_time) {
		name=_name;
		cate_id=_cate_id;
		...
		detail_description=_detail_description;
		selling_description=_selling_description;
